...
namespace Daily_Diary {
    ...
    public partial class UserDataSet : global::System.Data.DataSet {
        ...
        public partial class t_eventsDataTable : global::System.Data.TypedTableBase<t_eventsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public t_eventsRow Addt_eventsRow(string EventTitle, string EventDescription, string EventType, string EventDate, int UserId) {
...
namespace Daily_Diary.UserDataSetTableAdapters {
    ...
    public partial class t_eventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[t_events] ([EventTitle], [EventDescription], [EventType], [EventDate], [UserId]) VALUES (@EventTitle, @EventDescription, @EventType, @EventDate, @UserId);
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId FROM t_events WHERE (EventId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[t_events] SET [EventTitle] = @EventTitle, [EventDescription] = @EventDescription, [EventType] = @EventType, [EventDate] = @EventDate, [UserId] = @UserId WHERE (([EventTitle] = @Original_EventTitle) AND ([EventDescription] = @Original_EventDescription) AND ([EventType] = @Original_EventType) AND ([EventDate] = @Original_EventDate) AND ([EventId] = @Original_EventId) AND ((@IsNull_UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)));
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId FROM t_events WHERE (EventId = @EventId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId FROM d" +
                "bo.t_events";
        ...
        public virtual int Fill(UserDataSet.t_eventsDataTable dataTable) {
        ...
        public virtual UserDataSet.t_eventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet.t_eventsDataTable dataTable = new UserDataSet.t_eventsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet.t_eventsDataTable dataTable) {
        ...
        public virtual int Insert(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId) {
            if ((EventTitle == null)) {
        ...
        public virtual int Update(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId, string Original_EventTitle, string Original_EventDescription, string Original_EventType, string Original_EventDate, int Original_EventId, global::System.Nullable<int> Original_UserId, int EventId) {
            if ((EventTitle == null)) {
                throw new global::System.ArgumentNullException("EventTitle");
            }
            else {
            ...
            if ((Original_EventTitle == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_EventTitle));
            }
            if ((Original_EventDescription == null)) {
                throw new global::System.ArgumentNullException("Original_EventDescription");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_EventDescription));
            }
            if ((Original_EventType == null)) {
                throw new global::System.ArgumentNullException("Original_EventType");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(EventId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId, string Original_EventTitle, string Original_EventDescription, string Original_EventType, string Original_EventDate, int Original_EventId, global::System.Nullable<int> Original_UserId) {
            return this.Update(EventTitle, EventDescription, EventType, EventDate, UserId, Original_EventTitle, Original_EventDescription, Original_EventType, Original_EventDate, Original_EventId, Original_UserId, Original_EventId);
        }
    }
