...
namespace Daily_Diary.UserDataSet4TableAdapters {
...
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId, EventPicture, ModifyDate FROM t_events WHERE (EventId = @EventId)";
        ...
        public virtual int Fill(UserDataSet4.t_eventsDataTable dataTable) {
        ...
        public virtual UserDataSet4.t_eventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet4.t_eventsDataTable dataTable = new UserDataSet4.t_eventsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet4.t_eventsDataTable dataTable) {
