...
namespace Daily_Diary.UserDataSet1TableAdapters {
...
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId, EventPicture FROM t_events WHERE (EventId = @EventId)";
        ...
        public virtual int Fill(UserDataSet1.t_eventsDataTable dataTable) {
        ...
        public virtual UserDataSet1.t_eventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet1.t_eventsDataTable dataTable = new UserDataSet1.t_eventsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet1.t_eventsDataTable dataTable) {
