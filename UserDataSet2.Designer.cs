...
namespace Daily_Diary {
    ...
    public partial class UserDataSet2 : global::System.Data.DataSet {
        ...
        public partial class t_eventsDataTable : global::System.Data.TypedTableBase<t_eventsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public t_eventsRow Addt_eventsRow(string EventTitle, string EventDescription, string EventType, string EventDate, int UserId, byte[] EventPicture) {
...
namespace Daily_Diary.UserDataSet2TableAdapters {
    ...
    public partial class t_eventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[t_events] WHERE (([EventTitle] = @Original_EventTitle) AND ([EventDescription] = @Original_EventDescription) AND ([EventType] = @Original_EventType) AND ([EventDate] = @Original_EventDate) AND ([EventId] = @Original_EventId) AND ((@IsNull_UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[t_events] ([EventTitle], [EventDescription], [EventType], [EventDate], [UserId], [EventPicture]) VALUES (@EventTitle, @EventDescription, @EventType, @EventDate, @UserId, @EventPicture);
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId, EventPicture FROM t_events WHERE (EventId = SCOPE_IDENTITY())";
...
SELECT EventTitle, EventDescription, EventType, EventDate, EventId, UserId, EventPicture FROM t_events WHERE (EventId = @EventId)";
        ...
        public virtual int Fill(UserDataSet2.t_eventsDataTable dataTable) {
        ...
        public virtual UserDataSet2.t_eventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet2.t_eventsDataTable dataTable = new UserDataSet2.t_eventsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet2.t_eventsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_EventTitle, string Original_EventDescription, string Original_EventType, string Original_EventDate, int Original_EventId, global::System.Nullable<int> Original_UserId) {
        ...
        public virtual int Insert(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId, byte[] EventPicture) {
            if ((EventTitle == null)) {
        ...
        public virtual int Update(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId, byte[] EventPicture, string Original_EventTitle, string Original_EventDescription, string Original_EventType, string Original_EventDate, int Original_EventId, global::System.Nullable<int> Original_UserId, int EventId) {
            if ((EventTitle == null)) {
                throw new global::System.ArgumentNullException("EventTitle");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EventTitle, string EventDescription, string EventType, string EventDate, global::System.Nullable<int> UserId, byte[] EventPicture, string Original_EventTitle, string Original_EventDescription, string Original_EventType, string Original_EventDate, int Original_EventId, global::System.Nullable<int> Original_UserId) {
            return this.Update(EventTitle, EventDescription, EventType, EventDate, UserId, EventPicture, Original_EventTitle, Original_EventDescription, Original_EventType, Original_EventDate, Original_EventId, Original_UserId, Original_EventId);
        }
    }
